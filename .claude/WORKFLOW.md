...
This document defines the **mandatory** development workflow for SwiftFFMpeg. Claude Code MUST follow these conventions for ALL code changes, commits, pull requests, and releases.
...
This workflow applies to SwiftFFMpeg - FFmpeg wrapper for Swift with comprehensive audio/video processing capabilities.
